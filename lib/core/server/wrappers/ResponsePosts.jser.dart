...
part of 'ResponsePosts.dart';

// **************************************************************************
// JaguarSerializerGenerator
// **************************************************************************

abstract class _$ResponsePostsSerializer implements Serializer<ResponsePosts> {
  ...
  @override
  Map<String, dynamic> toMap(ResponsePosts model) {
  ...
  @override
  ResponsePosts fromMap(Map map) {
    if (map == null) return null;
    final obj = ResponsePosts();
